...
export default function Items() {
    ...
    const FormInput = ({ label, value, setValue, placeholder, width, error }: FormInputProps) => (
        <_.Wrapper>
            ...
            {error && <_.ErrorMessage><Image src="/assets/error.svg" alt="Error" width={16} height={16} />{error}</_.ErrorMessage>}
        </_.Wrapper>
    );
        ...
        <_.Container>
            ...
            {LockedGroups.includes(active as typeof LockedGroups[number]) ? (
                ...
                <>
                            ...
                            <_.Number>
                                ...
                                <_.Icons>
                                    {quantityIcons.map(({ onClick, src, alt }) => (
                                        <div key={alt} onClick={onClick}><Image src={src} alt={alt} width={12} height={12} /></div>
                                    ))}
                                </_.Icons>
                            </_.Number>
                        </_.Wrapper>
                    ...
                    <FormInput label="신청사유" value={reason} setValue={setReason} placeholder="신청 사유를 10자 이상 입력해주세요" width="100%" error={errors.reason} />
                    <_.BtnGroup>
